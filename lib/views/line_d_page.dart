...
class LineDPage extends StatefulWidget {
  final DateTime date;
  const LineDPage({Key? key, required this.date}) : super(key: key);

  @override
  _LineDPageState createState() => _LineDPageState();
}
...
class _LineDPageState extends State<LineDPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Line D Production - ${DateFormat('yyyy-MM-dd').format(widget.date)}',
          style: TextStyle(
