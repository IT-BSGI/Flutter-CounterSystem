...
class _LineCPageState extends State<LineCPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 15, 15, 15), // Changed to dark background
      appBar: AppBar(
        title: Row(
        ...
        centerTitle: false,
        backgroundColor: const Color.fromARGB(255, 10, 10, 10), // Darker app bar
      ),
      body: _isLoading
          ...
          : (_plan == null)
              ...
              : Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: Container( // Replaced Card with Container
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 15, 15, 15), // Dark container background
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: const Color.fromARGB(255, 255, 255, 255), // White text for dark background
              fontWeight: FontWeight.bold,
              height: 0.9,
            ),
          ),
